...
import { rowSumOddNumbers } from './kata';

describe('basic tests', function () {
  it('Testing for 1', () => assert.strictEqual(rowSumOddNumbers(1), 1));
  it('Testing for 2', () => assert.strictEqual(rowSumOddNumbers(2), 8));
  it('Testing for 3', () => assert.strictEqual(rowSumOddNumbers(3), 27));
  //  it("Testing for 4", () => assert.strictEqual(rowSumOddNumbers(4), 27));
  ...
  it('Testing for 101', () =>
    assert.strictEqual(rowSumOddNumbers(101), 1030301));
});
